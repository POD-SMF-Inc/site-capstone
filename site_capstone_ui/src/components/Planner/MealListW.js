        ...
        <section className="monday">
          ...
          <div className="dayMacro">
            <ul>
              ...
              <li>Carbohydrates: {week.monday.nutrients.carbohydrates.toFixed(0)}</li>
        ...
        <section className="tuesday">
          ...
          <div className="dayMacro">
            <ul>
              ...
              <li>Carbohydrates: {week.tuesday.nutrients.carbohydrates.toFixed(0)}</li>
        ...
        <section className="thursday">
          ...
          <div className="dayMacro">
            <ul>
              ...
              <li>Carbohydrates: {week.thursday.nutrients.carbohydrates.toFixed(0)}</li>
        ...
        <section className="friday">
          ...
          <div className="dayMacro">
            <ul>
              ...
              <li>Carbohydrates: {week.friday.nutrients.carbohydrates.toFixed(0)}</li>
        ...
        <section className="saturday">
          ...
          <div className="dayMacro">
            <ul>
              ...
              <li>Carbohydrates: {week.saturday.nutrients.carbohydrates.toFixed(0)}</li>
        ...
        <section className="sunday">
          ...
          <div className="dayMacro">
            <ul>
              ...
              <li>Carbohydrates: {week.sunday.nutrients.carbohydrates.toFixed(0)}</li>
